...
api.add_resource(WeatherForecastItem, "/locations/<location:location>/forecasts/<forecast:forecast>/")

api.add_resource(WeatherReports, "/locations/<location:location>/reports/")
api.add_resource(WeatherReportItem, "/locations/<location:location>/reports/<report:report>/")
